...
// Use this for on-chain Verification - bb prove -b ./target/ghostprover.json -w ./target/ghostprover.gz -o ./target --oracle_hash keccak

// This contract is Autogenerated by using Barretenberg's write_solidity_verifier command
...
library HonkVerificationKey {
        ...
        returns (Honk.VerificationKey memory)
    {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({
                x: uint256(
                    0x157fc445682522001abdc28df700570484b2b01691c2e5e2cabbe140ec8c3ebf
                ),
                y: uint256(
                    0x0f9690efb3b8429798b0b2bf5fbc64ad82f4cd4f082214f6cb40db1fe28d752b
                )
            }),
            qr: Honk.G1Point({
                x: uint256(
                    0x0296be32c9b316b8a333530828f651c9e07442fbd4f2fee98e742289177ba534
                ),
                y: uint256(
                    0x0526f799787173a9189dfc7c597883eb4b5f9987a4bcbfe5f5f70c812b8cdbdb
                )
            }),
            qo: Honk.G1Point({
                x: uint256(
                    0x0f48b1a502f069d4130eb29e26590e07cddca85136fb51654d479abf79d739ba
                ),
                y: uint256(
                    0x13deee424c38b42fa9ab32aa7a1bb6d01ce07c3ec7f1a71282feafe9c1e9a3ca
                )
            }),
            q4: Honk.G1Point({
                x: uint256(
                    0x0c4d32ab48fc3f6e920b60e93dc9383d1473a6e5a1830d90328123c2a5d9fb16
                ),
                y: uint256(
                    0x2680ff9633764fea1be89907a3b58d4d2632eaa0e71d4abb5c8fc8cde0817260
                )
            }),
            qm: Honk.G1Point({
                x: uint256(
                    0x1b3c4eaa7f00c3fd911aa22414ca1fbaebcef47a2f8f51156543be6871a13a0c
                ),
                y: uint256(
                    0x0d2908af7c7a9e4bf709cfc419de4ae4b9e686f69c7dafba48eec02306aa6167
                )
            }),
            qc: Honk.G1Point({
                x: uint256(
                    0x0a0106732d583511b7558360a11747c84b18c755382765c5559c8b47bb87203b
                ),
                y: uint256(
                    0x071644bc9c8dd0b58e7b926cd5bd2987f8d596ccfd4ed8d79f27042cb2d21d08
                )
            }),
            qLookup: Honk.G1Point({
                x: uint256(
                    0x1bb0476d951ac63700ce2c49a098f286cda6e48c58afad92e17fdca8597bc70c
                ),
                y: uint256(
                    0x1a2dd67195770a01dd12aa3dbf7cb7a068a95b5cca74583356c05da4b13b454b
                )
            }),
            qArith: Honk.G1Point({
                x: uint256(
                    0x0373145fe906d1e6a9a2898edbdce16976bd032f0ab1de99e4407f22d872604a
                ),
                y: uint256(
                    0x111681c0b64b567facf91ad38243dde912c3cd38c925d1609d816b6e328aca50
                )
            }),
            qDeltaRange: Honk.G1Point({
                x: uint256(
                    0x2fbefa6a4388b7b1cadabdb79aa4a9aa4b2fa6704d0b1b66e3b0a1852b112f2c
                ),
                y: uint256(
                    0x148e873c1900e79ea1f972e75a1c5d18e5220ce9ecb86695822e022a403e8d6f
                )
            }),
            qElliptic: Honk.G1Point({
                x: uint256(
                    0x1dc11e5d0741cdbedb40f2e523c13f260ce9b93110f5ad4cc183e1b369ad6eb3
                ),
                y: uint256(
                    0x20b401b278a0fd0d710080ee06b739aea54560145bae44b3956167ae426f4e32
                )
            }),
            qMemory: Honk.G1Point({
                x: uint256(
                    0x09af52f384e60111e7270c4937f0126d264070e6a5385144dee8bea5db36eea8
                ),
                y: uint256(
                    0x165ebd5e85ed5537cb270173d5d161309c68d9cea12f5ff9a4ecd4c5f0e7d971
                )
            }),
            qNnf: Honk.G1Point({
                x: uint256(
                    0x009bd7ca92c51aef728398a62e62b26e89733dc39cb0697b9aa7ecc4c310dce7
                ),
                y: uint256(
                    0x08a116e277ef6836061f380547751f65b271160c323f37cb9eb16f6d5ae108db
                )
            }),
            qPoseidon2External: Honk.G1Point({
                x: uint256(
                    0x1ce106a9baf998cb8ecd8641c4ef0456e999d23f55ee662dfeb61fa4ed11e855
                ),
                y: uint256(
                    0x1a1f62942627193390d4ceb7490f74e737f46e96136c705fb6cd3f71f94dc2ef
                )
            }),
            qPoseidon2Internal: Honk.G1Point({
                x: uint256(
                    0x17d384b57110d340ffab5b33a0a138b72ddbbfc57d7fe5ed885f0af87eace8c4
                ),
                y: uint256(
                    0x223a6cb97679d9bfbd0d9dabddbb611d2866dae35f1d1bfb3b00dabceed5f83c
                )
            }),
            s1: Honk.G1Point({
                x: uint256(
                    0x15ce8d38ee1e6e0407f672361ffde43df435f600c61e1c22b63a4688306f2030
                ),
                y: uint256(
                    0x27861ed64cd4f688299ff7957a4f1429fa8ff250270359f55501347a4ef5cdbe
                )
            }),
            s2: Honk.G1Point({
                x: uint256(
                    0x0499157a72e0dbf2b9719b797a66134ca954d977a94c5679f45cbdc0583d9a37
                ),
                y: uint256(
                    0x25afa0474ab336fc056963976da0539ea1f7768f8690648a7239b6557d0c8438
                )
            }),
            s3: Honk.G1Point({
                x: uint256(
                    0x1b256c61a8ee814d3405b14674cc416959dbacdc72e5c6414c4edb65058c3e75
                ),
                y: uint256(
                    0x2708cbb3abc69a592531a4ee6675b5afd137e5837c52f4a831fc6ad12de8d04c
                )
            }),
            s4: Honk.G1Point({
                x: uint256(
                    0x28e2affceaaae6df328e7dfb3c36b21e3bbfff295fa6cb1a5f4377ea8e6c08d0
                ),
                y: uint256(
                    0x0cf2f028f3bca1466ee5dfba46be43cde0c47af012bb0a2abfae4640a66966b7
                )
            }),
            t1: Honk.G1Point({
                x: uint256(
            ...
            id1: Honk.G1Point({
                x: uint256(
                    0x177110c1147a367c8d8aa67b03f64280a0ee7666b25b02e7c30e5c275c095927
                ),
                y: uint256(
                    0x2c08d1caff15714203cb0f8a6fdc2183f1ecff1e925c05d710ac6bc2788eadf2
                )
            }),
            id2: Honk.G1Point({
                x: uint256(
                    0x07090f3fd54ece50df106e70d5e2c9f5cb01d99b4ee1b0e731da8a02af891758
                ),
                y: uint256(
                    0x2bde674b6c4de480a6244b3f9acbed6d36b0e96f61ebffd067d714d3c52301fa
                )
            }),
            id3: Honk.G1Point({
                x: uint256(
                    0x10adc5ef89caeda4d5b725e487dc2331fef0bfec9cb711c85bd92410568c3bb2
                ),
                y: uint256(
                    0x12c1bc4904a389ed9bc09ee7e3b21a5659798197de7af66f2c7b453321feb63f
                )
            }),
            id4: Honk.G1Point({
                x: uint256(
                    0x20ab0005a3af445dee0b7a7bf98d9f4377d63668c878ed83e0bbbe62bcd1b939
                ),
                y: uint256(
                    0x1fed5acbe4a2d4f218144da41fea8d010043a9ad8deea1c40ef77896b53de1b3
                )
            }),
            ...
            lagrangeLast: Honk.G1Point({
                x: uint256(
                    0x10c9e3ed3946281e960e06a453c876c24424b63c354a4fdc0db9e8207613440f
                ),
                y: uint256(
                    0x0052ba84b259e159256af5cbd24a3377510798b9c97fdcb5623ef7765b7828e5
                )
            })
        });
        return vk;
